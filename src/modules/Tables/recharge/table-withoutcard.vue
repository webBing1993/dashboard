<template>
  <div class="v-table">
    <table border="0">
      ...
      <tbody>
      <tr v-for="(obj, index) of withoutCardList">
        ...
        <td class="v-item" v-if="obj.status=='AUTO_AGREED'">自动通过</td>
        <td class="v-item" v-if="obj.status=='AUTO_REFUSED'">自动拒绝</td>
        <td class="v-item" v-if="obj.status=='FAILED'">验证失败</td>
